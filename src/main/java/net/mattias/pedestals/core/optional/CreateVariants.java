...
public class CreateVariants {
    ...
    public static final PedestalVariant CUT_DRIPSTONE = PedestalVariants.register(new PedestalVariant("cut_dripstone_pedestal", "cut_dripstone", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_dripstone"))));
    public static final PedestalVariant POLISHED_CUT_DRIPSTONE = PedestalVariants.register(new PedestalVariant("polished_cut_dripstone_pedestal", "polished_cut_dripstone", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "polished_cut_dripstone"))));
    public static final PedestalVariant CUT_DRIPSTONE_BRICKS = PedestalVariants.register(new PedestalVariant("cut_dripstone_bricks_pedestal", "cut_dripstone_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_dripstone_bricks"))));
    public static final PedestalVariant SMALL_DRIPSTONE_BRICKS = PedestalVariants.register(new PedestalVariant("small_dripstone_bricks_pedestal", "small_dripstone_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "small_dripstone_bricks"))));
    public static final PedestalVariant LAYERED_DRIPSTONE = PedestalVariants.register(new PedestalVariant("layered_dripstone_pedestal", "layered_dripstone", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "layered_dripstone"))));
    public static final PedestalVariant DRIPSTONE_PILLAR = PedestalVariants.register(new PedestalVariant("dripstone_pillar_pedestal", "dripstone_pillar", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "dripstone_pillar"))));
    public static final PedestalVariant CUT_DEEPSLATE = PedestalVariants.register(new PedestalVariant("cut_deepslate_pedestal", "cut_deepslate", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_deepslate"))));
    public static final PedestalVariant POLISHED_CUT_DEEPSLATE = PedestalVariants.register(new PedestalVariant("polished_cut_deepslate_pedestal", "polished_cut_deepslate", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "polished_cut_deepslate"))));
    public static final PedestalVariant CUT_DEEPSLATE_BRICKS = PedestalVariants.register(new PedestalVariant("cut_deepslate_bricks_pedestal", "cut_deepslate_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_deepslate_bricks"))));
    public static final PedestalVariant SMALL_DEEPSLATE_BRICKS = PedestalVariants.register(new PedestalVariant("small_deepslate_bricks_pedestal", "small_deepslate_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "small_deepslate_bricks"))));
    public static final PedestalVariant LAYERED_DEEPSLATE = PedestalVariants.register(new PedestalVariant("layered_deepslate_pedestal", "layered_deepslate", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "layered_deepslate"))));
    public static final PedestalVariant DEEPSLATE_PILLAR = PedestalVariants.register(new PedestalVariant("deepslate_pillar_pedestal", "deepslate_pillar", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "deepslate_pillar"))));
    public static final PedestalVariant CUT_TUFF = PedestalVariants.register(new PedestalVariant("cut_tuff_pedestal", "cut_tuff", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_tuff"))));
    public static final PedestalVariant POLISHED_CUT_TUFF = PedestalVariants.register(new PedestalVariant("polished_cut_tuff_pedestal", "polished_cut_tuff", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "polished_cut_tuff"))));
    public static final PedestalVariant CUT_TUFF_BRICKS = PedestalVariants.register(new PedestalVariant("cut_tuff_bricks_pedestal", "cut_tuff_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_tuff_bricks"))));
    public static final PedestalVariant SMALL_TUFF_BRICKS = PedestalVariants.register(new PedestalVariant("small_tuff_bricks_pedestal", "small_tuff_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "small_tuff_bricks"))));
    public static final PedestalVariant LAYERED_TUFF = PedestalVariants.register(new PedestalVariant("layered_tuff_pedestal", "layered_tuff", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "layered_tuff"))));
    public static final PedestalVariant TUFF_PILLAR = PedestalVariants.register(new PedestalVariant("tuff_pillar_pedestal", "tuff_pillar", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "tuff_pillar"))));
    public static final PedestalVariant ASURINE = PedestalVariants.register(new PedestalVariant("asurine_pedestal", "asurine", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "asurine"))));
    public static final PedestalVariant CUT_ASURINE = PedestalVariants.register(new PedestalVariant("cut_asurine_pedestal", "cut_asurine", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_asurine"))));
    public static final PedestalVariant POLISHED_CUT_ASURINE = PedestalVariants.register(new PedestalVariant("polished_cut_asurine_pedestal", "polished_cut_asurine", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "polished_cut_asurine"))));
    public static final PedestalVariant CUT_ASURINE_BRICKS = PedestalVariants.register(new PedestalVariant("cut_asurine_bricks_pedestal", "cut_asurine_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_asurine_bricks"))));
    public static final PedestalVariant SMALL_ASURINE_BRICKS = PedestalVariants.register(new PedestalVariant("small_asurine_bricks_pedestal", "small_asurine_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "small_asurine_bricks"))));
    public static final PedestalVariant LAYERED_ASURINE = PedestalVariants.register(new PedestalVariant("layered_asurine_pedestal", "layered_asurine", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "layered_asurine"))));
    public static final PedestalVariant ASURINE_PILLAR = PedestalVariants.register(new PedestalVariant("asurine_pillar_pedestal", "asurine_pillar", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "asurine_pillar"))));
    public static final PedestalVariant CRIMSITE = PedestalVariants.register(new PedestalVariant("crimsite_pedestal", "crimsite", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "crimsite"))));
    public static final PedestalVariant CUT_CRIMSITE = PedestalVariants.register(new PedestalVariant("cut_crimsite_pedestal", "cut_crimsite", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_crimsite"))));
    public static final PedestalVariant POLISHED_CUT_CRIMSITE = PedestalVariants.register(new PedestalVariant("polished_cut_crimsite_pedestal", "polished_cut_crimsite", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "polished_cut_crimsite"))));
    public static final PedestalVariant CUT_CRIMSITE_BRICKS = PedestalVariants.register(new PedestalVariant("cut_crimsite_bricks_pedestal", "cut_crimsite_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_crimsite_bricks"))));
    public static final PedestalVariant SMALL_CRIMSITE_BRICKS = PedestalVariants.register(new PedestalVariant("small_crimsite_bricks_pedestal", "small_crimsite_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "small_crimsite_bricks"))));
    public static final PedestalVariant LAYERED_CRIMSITE = PedestalVariants.register(new PedestalVariant("layered_crimsite_pedestal", "layered_crimsite", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "layered_crimsite"))));
    public static final PedestalVariant CRIMSITE_PILLAR = PedestalVariants.register(new PedestalVariant("crimsite_pillar_pedestal", "crimsite_pillar", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "crimsite_pillar"))));
    public static final PedestalVariant LIMESTONE = PedestalVariants.register(new PedestalVariant("limestone_pedestal", "limestone", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "limestone"))));
    public static final PedestalVariant CUT_LIMESTONE = PedestalVariants.register(new PedestalVariant("cut_limestone_pedestal", "cut_limestone", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_limestone"))));
    public static final PedestalVariant POLISHED_CUT_LIMESTONE = PedestalVariants.register(new PedestalVariant("polished_cut_limestone_pedestal", "polished_cut_limestone", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "polished_cut_limestone"))));
    public static final PedestalVariant CUT_LIMESTONE_BRICKS = PedestalVariants.register(new PedestalVariant("cut_limestone_bricks_pedestal", "cut_limestone_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "cut_limestone_bricks"))));
    public static final PedestalVariant SMALL_LIMESTONE_BRICKS = PedestalVariants.register(new PedestalVariant("small_limestone_bricks_pedestal", "small_limestone_bricks", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "small_limestone_bricks"))));
    public static final PedestalVariant LAYERED_LIMESTONE = PedestalVariants.register(new PedestalVariant("layered_limestone_pedestal", "layered_limestone", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "layered_limestone"))));
    public static final PedestalVariant LIMESTONE_PILLAR = PedestalVariants.register(new PedestalVariant("limestone_pillar_pedestal", "limestone_pillar", () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation("create", "limestone_pillar"))));
