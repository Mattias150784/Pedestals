...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
       ...
       pedestalBlock(ModBlocks.NETHER_BRICKS_PEDESTAL.get(), "nether_bricks_pedestal");
        ...
        pedestalBlock(ModBlocks.BLACK_WOOL_PEDESTAL.get(), "black_wool_pedestal");
        pedestalBlock(ModBlocks.BLUE_WOOL_PEDESTAL.get(), "blue_wool_pedestal");
        pedestalBlock(ModBlocks.BROWN_WOOL_PEDESTAL.get(), "brown_wool_pedestal");
        pedestalBlock(ModBlocks.CYAN_WOOL_PEDESTAL.get(), "cyan_wool_pedestal");
        pedestalBlock(ModBlocks.GRAY_WOOL_PEDESTAL.get(), "gray_wool_pedestal");
        pedestalBlock(ModBlocks.GREEN_WOOL_PEDESTAL.get(), "green_wool_pedestal");
        pedestalBlock(ModBlocks.LIGHT_BLUE_WOOL_PEDESTAL.get(), "light_blue_wool_pedestal");
        pedestalBlock(ModBlocks.LIGHT_GRAY_WOOL_PEDESTAL.get(), "light_gray_wool_pedestal");
        pedestalBlock(ModBlocks.LIME_WOOL_PEDESTAL.get(), "lime_wool_pedestal");
        pedestalBlock(ModBlocks.MAGENTA_WOOL_PEDESTAL.get(), "magenta_wool_pedestal");
        pedestalBlock(ModBlocks.ORANGE_WOOL_PEDESTAL.get(), "orange_wool_pedestal");
        pedestalBlock(ModBlocks.PINK_WOOL_PEDESTAL.get(), "pink_wool_pedestal");
        pedestalBlock(ModBlocks.PURPLE_WOOL_PEDESTAL.get(), "purple_wool_pedestal");
        pedestalBlock(ModBlocks.RED_WOOL_PEDESTAL.get(), "red_wool_pedestal");
        pedestalBlock(ModBlocks.WHITE_WOOL_PEDESTAL.get(), "white_wool_pedestal");
        pedestalBlock(ModBlocks.YELLOW_WOOL_PEDESTAL.get(), "yellow_wool_pedestal");
