...
import net.mattias.pedestals.screen.custom.nether.screen.*;
...
import net.mattias.pedestals.block.entity.renderer.nether.*;
...
public class Pedestals
{
    ...
    public class ClientModEvents
    {
        ...
        public static void onClientSetup(FMLClientSetupEvent event)
        {
            ...
            MenuScreens.register(ModMenuTypes.END_STONE_BRICKS_PEDESTAL_MENU.get(), EndStoneBricksPedestalScreen::new);
