...
public class DarkOakLogPedestalScreen extends AbstractContainerScreen<DarkOakLogPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            new ResourceLocation(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");

    public DarkOakLogPedestalScreen(DarkOakLogPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
