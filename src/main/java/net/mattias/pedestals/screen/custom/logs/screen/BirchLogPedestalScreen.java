...
public class BirchLogPedestalScreen extends AbstractContainerScreen<BirchLogPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            new ResourceLocation(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");

    public BirchLogPedestalScreen(BirchLogPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
