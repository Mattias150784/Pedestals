...
public class GoldPedestalScreen extends AbstractContainerScreen<GoldPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");
    public GoldPedestalScreen(GoldPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
