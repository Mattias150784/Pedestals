...
public class CherryLogPedestalScreen extends AbstractContainerScreen<CherryLogPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            new ResourceLocation(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");

    public CherryLogPedestalScreen(CherryLogPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
