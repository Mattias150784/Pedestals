...
public class SpruceLogPedestalScreen extends AbstractContainerScreen<SpruceLogPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            new ResourceLocation(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");

    public SpruceLogPedestalScreen(SpruceLogPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
