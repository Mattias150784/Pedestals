...
public class JungleLogPedestalScreen extends AbstractContainerScreen<JungleLogPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            new ResourceLocation(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");

    public JungleLogPedestalScreen(JungleLogPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
