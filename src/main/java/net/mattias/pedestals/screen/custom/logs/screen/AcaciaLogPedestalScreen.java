...
public class AcaciaLogPedestalScreen extends AbstractContainerScreen<AcaciaLogPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            new ResourceLocation(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");

    public AcaciaLogPedestalScreen(AcaciaLogPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
