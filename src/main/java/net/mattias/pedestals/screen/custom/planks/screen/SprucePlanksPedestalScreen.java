...
public class SprucePlanksPedestalScreen extends AbstractContainerScreen<SprucePlanksPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");
    public SprucePlanksPedestalScreen(SprucePlanksPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
