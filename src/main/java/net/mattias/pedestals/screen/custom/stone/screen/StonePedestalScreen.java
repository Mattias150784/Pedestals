...
public class StonePedestalScreen extends AbstractContainerScreen<StonePedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            new ResourceLocation(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");

    public StonePedestalScreen(StonePedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
