...
public class OakLogPedestalScreen extends AbstractContainerScreen<OakLogPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            new ResourceLocation(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");

    public OakLogPedestalScreen(OakLogPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
