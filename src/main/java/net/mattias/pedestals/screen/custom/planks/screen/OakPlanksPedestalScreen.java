...
public class OakPlanksPedestalScreen extends AbstractContainerScreen<OakPlanksPedestalMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Pedestals.MOD_ID, "textures/gui/pedestal/pedestal_gui.png");
    public OakPlanksPedestalScreen(OakPlanksPedestalMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
