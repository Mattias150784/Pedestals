...
public class PolishedGranitePedestalBlockEntityRenderer implements BlockEntityRenderer<PolishedGranitePedestalBlockEntity> {
    ...
    @Override
    public void render(PolishedGranitePedestalBlockEntity PolishedGranitePedestalBlockEntity, float v, PoseStack poseStack,
                       MultiBufferSource multiBufferSource, int i, int i1) {
        ItemRenderer itemRenderer = Minecraft.getInstance().getItemRenderer();
        ItemStack stack = PolishedGranitePedestalBlockEntity.getItem(0);
        Level level = PolishedGranitePedestalBlockEntity.getLevel();
        ...
        itemRenderer.renderStatic(stack, ItemDisplayContext.FIXED, getLightLevel(level, PolishedGranitePedestalBlockEntity.getBlockPos()),
