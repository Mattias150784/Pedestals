...
public class AcaciaLogPedestalBlockEntityRenderer implements BlockEntityRenderer<AcaciaLogPedestalBlockEntity> {
    ...
    @Override
    public void render(AcaciaLogPedestalBlockEntity acaciaLogPedestalBlockEntity, float v, PoseStack poseStack,
                       MultiBufferSource multiBufferSource, int i, int i1) {
        ItemRenderer itemRenderer = Minecraft.getInstance().getItemRenderer();
        ItemStack stack = acaciaLogPedestalBlockEntity.getItem(0);
        ...
        itemRenderer.renderStatic(stack, ItemDisplayContext.FIXED, getLightLevel(level, acaciaLogPedestalBlockEntity.getBlockPos()),
